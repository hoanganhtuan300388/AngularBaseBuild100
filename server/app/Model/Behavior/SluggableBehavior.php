...
class SluggableBehavior extends ModelBehavior
{
    ...
    function beforeSave(Model $Model)
    {
        ...
        if ($Model->hasField($this->__settings[$Model->alias]['slug']) && ($this->__settings[$Model->alias]['overwrite'] || empty($Model->id)))
        {
			...
			if(empty($Model->data[$Model->alias][$this->__settings[$Model->alias]['slug']]) || $Model->data[$Model->alias][$this->__settings[$Model->alias]['slug']] == null) 
			{
	            foreach($this->__settings[$Model->alias]['label'] as $field)
	            {
			...
			{
				$label = $Model->data[$Model->alias][$this->__settings[$Model->alias]['slug']];
			}
