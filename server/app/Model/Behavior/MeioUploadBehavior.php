    ...
    var $default_options = array(
        ...
        'validations' => array(
            'FieldName' => array(
                ...
                'check' => true,
                'message' => 'This field has not been defined between the parameters of MeioUploadBehavior.'
            ),
            'Dir' => array(
                'rule' => array('uploadCheckDir'),
                'check' => true,
                'message' => 'The directory where the file would be placed there or is protected against writing.'
            ),
            'Empty' => array(
